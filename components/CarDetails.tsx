...
const CarDetails: FC<CarsDetailsProps> = ({ isOpen, car, closeModel }) => {
                ...
                <Dialog.Panel className="relative w-full max-w-lg max-h-[90hv] overflow-y-auto transform bg-white p-6 rounded-2xl text-left shadow-xl transition-all flex flex-col gap-5">
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
                        <Image
                          src={generateCarImageUrl(car, "35")}
                          alt="car model"
                          fill
                          priority
                          className="object-contain"
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    ...
                    <div className="mt-3 flex flex-wrap gap-4">
                      {Object.entries(carWithoutId).map(([key, desc]) => (
                        <div
                        ...
                        >
                          ...
                          <p className="text-black-100 font-semibold">{desc}</p>
                        </div>
                      ))}
                    </div>
                  </div>
